...
A minimal native Kotlin Android overlay for entering GTA Vice City cheat codes. It uses Shizuku's privileged shell to send individual Android key events (40 ms apart), without root.

## Requirements

- Android 8.0 (API 26) or newer
- [Shizuku](https://shizuku.rikka.app/) installed, started, and authorized for this app
...
2. Open Vice Cheat Overlay, grant Shizuku and overlay permissions, then tap **Start floating bubble**.
3. Open GTA Vice City. Drag the `VC` bubble wherever convenient.
